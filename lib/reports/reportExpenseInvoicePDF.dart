...
class reportExpenseInvoicePDF {
        ...
        children: [
          pw.Padding(
            ...
            child: pw.Column(
              ...
              children: [
                pw.Text(
                  ' رقم الفاتورة : ${VMExpenseInvoice.MaxInvoices}',
                  style: pwTableHeadingTextStyle(fontPage, 14),
                ),
          ...
          pw.Padding(
            ...
            child: pw.Column(
                ...
                children: [
                  pw.Text(
                      " رقم الحساب : ${VMExpenseInvoice.AccountingPerson_select_id}",
                      style: pwTableHeadingTextStyle(fontPage, 14)),
                  pw.Text(
                    ' الساعة: ${VMExpenseInvoice.Selectedtime.hour}:${VMExpenseInvoice.Selectedtime.minute}',
                    style: pwTableHeadingTextStyle(fontPage, 14),
                  ),
                ]),
          ),
          pw.Padding(
            ...
            child: pw.Column(
                ...
                children: [
                  pw.Text(
                      " اسم الحساب : ${VMExpenseInvoice.AccountingPerson_select_name}",
                      style: pwTableHeadingTextStyle(fontPage, 14)),
                  pw.Text(
                    ' التاريخ: ${VMExpenseInvoice.dateDate.day}/${VMExpenseInvoice.dateDate.month}/${VMExpenseInvoice.dateDate.year}',
                    style: pwTableHeadingTextStyle(fontPage, 14),
                  ),
                ]),
          ),
        ...
        children: [
          pw.Padding(
            ...
            child: pw.Column(
              ...
              children: [
                pw.Text(
                  '    الفاتورة الإجمالية : ${VMExpenseInvoice.amount_all} ${VMExpenseInvoice.currencySelect} ',
                  style: pwTableHeadingTextStyle(fontPage, 14,
    ...
    if (VMExpenseInvoice.remaining > 0) {
      return pw.Padding(
        ...
        child:
          ...
          pw.Text(
            '   قيمة الخصم : ${VMExpenseInvoice.disscount} ${VMExpenseInvoice.currencySelect} ',
            style: pwTableHeadingTextStyle(fontPage, 14),
          ),
          pw.Text(
            '  المبلغ المتبقي   : ${VMExpenseInvoice.remaining} ${VMExpenseInvoice.currencySelect} ',
            style: pwTableHeadingTextStyle(fontPage, 14,
                color: PdfColor(1, 0, 0, .8)),
          ),
        ]),
      );
    } else {
  ...
  pw.Padding payedMony(pw.Font fontPage) {
    ...
    children.add(pw.Text(
        'مبلغ الفاتورة : ${VMExpenseInvoice.amount} ${VMExpenseInvoice.currencySelect} ',
        style: pwTableHeadingTextStyle(fontPage, 12)));

    if (VMExpenseInvoice.payment > 0) {
      children.add(pw.Text(
          'المدفوع نقداً : ${VMExpenseInvoice.payment} ${VMExpenseInvoice.payment_currency} ',
          style: pwTableHeadingTextStyle(fontPage, 12, color: PdfColors.blue)));
    }

    if (VMExpenseInvoice.payment_app > 0) {
      children.add(pw.Text(
          'المدفوع تطبيق : ${VMExpenseInvoice.payment_app} ${VMExpenseInvoice.payment_currency} ',
          style: pwTableHeadingTextStyle(fontPage, 12, color: PdfColors.blue)));
    }
