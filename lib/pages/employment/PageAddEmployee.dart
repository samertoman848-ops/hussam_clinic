...
class PageAddEmployee extends StatefulWidget {
  const PageAddEmployee({super.key});

  @override
  State<PageAddEmployee> createState() => _PageAddEmployeeState();
}

class _PageAddEmployeeState extends State<PageAddEmployee> {
  ...
  void _saveEmployee() async {
    if (_formKey.currentState!.validate()) {
      ...
      await DbEmployee().addEmployee(_name, _mobile, _jop);
      await AllEmplyess();
      if (mounted) {
